package bg.srebrinb.junk.web.rest;

import bg.srebrinb.junk.config.Constants;
import bg.srebrinb.junk.JhipsterSampleApplicationApp;
import bg.srebrinb.junk.domain.Authority;
import bg.srebrinb.junk.domain.User;
import bg.srebrinb.junk.repository.AuthorityRepository;
import bg.srebrinb.junk.repository.UserRepository;
import bg.srebrinb.junk.security.AuthoritiesConstants;
import bg.srebrinb.junk.service.MailService;
import bg.srebrinb.junk.service.dto.UserDTO;
import bg.srebrinb.junk.web.rest.errors.ExceptionTranslator;
import bg.srebrinb.junk.web.rest.vm.KeyAndPasswordVM;
import bg.srebrinb.junk.web.rest.vm.ManagedUserVM;
import bg.srebrinb.junk.service.UserService;
